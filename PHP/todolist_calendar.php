                ...
                <div class="calendar">
                    <div class="todo-get-calendar">
                        <div class="nav">
                            ...
                            <a href="/todolist_calendar.php?<?php echo $month == 1 ? 'year='.($year - 1).'&month=12' : 'year='.$year.'&month='.str_pad($month-1, 2, '0', STR_PAD_LEFT); ?>">
                            ...
                            <a href="/todolist_calendar.php?<?php echo $month == 12 ? 'year='.($year + 1).'&month=01' : 'year='.$year.'&month='.str_pad($month+1, 2, '0', STR_PAD_LEFT); ?>">
