                    ...
                    <form action="./todolist_list.php" method="POST">
                        <div class="list-box">
                            ...
                            <label for="content" class="text-list">
                                <input type="text" id="content" name="content" autocomplete="off" placeholder="할일을 추가하세요!" />
                            </label> <!-- 할일 내용 입력 필드 -->
                            <button type="submit">
                    ...
                    <form action="/todolist_list.php" method="get">
                        <div class="todo-get-calendar">
                            <div class="nav">
                                ...
                                <a href="/todolist_list.php?<?php echo $month == 1 ? 'year='.($year - 1).'&month=12' : 'year='.$year.'&month='.str_pad($month-1, 2, '0', STR_PAD_LEFT); ?>">
                                            ...
                                            <?php for ($k = 0; $k < 7; $k++) { ?>
                                                <li>
                                                    ...
                                                    <?php if (($n > 1 || $k >= $start_week) && ($total_day >= $n)) { ?>
                                                        ...
                                                        <button type="submit" class="<?php echo ($selected_date === ($year . '-' . str_pad($month, 2, '0', STR_PAD_LEFT) . '-' . str_pad($n, 2, '0', STR_PAD_LEFT))) ? 'btn-selected-date' : ''; ?>" name="selected_date" value="<?php echo $year . '-' . str_pad($month, 2, '0', STR_PAD_LEFT) . '-' . str_pad($n, 2, '0', STR_PAD_LEFT); ?>">
                                                            <!-- 현재 날짜를 보여주고 1씩 더해줌 -->
                                                            <?php echo $n++ ?>
                                                        </button>
                                                    <?php } ?>
