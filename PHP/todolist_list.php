...
try {
    ...
    if(REQUEST_METHOD === "GET") {
        ...
        $selected_date = isset($_GET["created_at"]) ? $_GET["created_at"] : date("Y-m-d"); // 날짜 획득
       ...
       $arr_param = [
        ...
        $result = db_update_todos($conn, $arr_param);

       
       $conn->commit();
       header("location:./todolist_list.php?page=".$page);
       exit;
  }
} catch (\Throwable $e) {
...
<body>
    <header>
        ...
        <a href="">
            <img class="header-profile-img" src="../HTML/img/11zon_cropped__2_-removebg-preview.png" />
        </a>
    </header>
    <main class="main-box">
        <div class="box">
                ...
                <div class="content-list">
                    <form action="./todolist_list.php" method="POST">
                        <div class="list-box">
                            ...
                            <label for="text" class="text-list">
        ...
        ?>
                        <div class="scroll">
                            <div class="chk-list">
                                ...
                                <input type="text" value="<?echo $item["content"] ?>" />
                                <button type="submit">
                                    <img
                    ...
                    <form action="./todolist_list.html" method="get">
                            ...
                            <div class="calendar">
                                <div class="calendar-detail">
                                    ...
                                    <ul class="days">
                                        ...
                                        $last_day = date('t', strtotime($selected_date));
                                        $month_year = date('Y-m', strtotime($selected_date));

                                        // 이번 달의 날짜를 출력
                                        for ($i = 1; $i <= $last_day; $i++) {
                                            $day = str_pad($i, 2, '0', STR_PAD_LEFT);
                                            $full_date = $month_year . '-' . $day;
                                            $class = ($i == date('d', strtotime($selected_date))) ? 'active' : ''; // 현재 날짜면 active 클래스 추가
                                        ?>
                                            <li class="<?php echo $class; ?>">
                                                <a href="?date=<?php echo $full_date; ?>"><?php echo $i; ?></a>
                                            </li>
                                        <?php } ?>
                                    </ul>
                                </div>
